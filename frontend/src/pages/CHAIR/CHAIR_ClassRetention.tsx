...
import { Send, Check, ChevronDown, Search } from "lucide-react";
...
export default function CHAIR_ClassRetention() {
  ...
  // Same demo data + behavior as OM_ClassRetention to guarantee parity
  const data = [
    {
      course: "CCPROG3",
    ...
    <main className="w-full px-8 py-8">
      ...
      <header className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Review and forward low-enrollment class retention requests for the active term.
        </p>
      </header>
      ...
      <div className="mb-6 flex flex-wrap items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <SelectBox
          value={status}
          onChange={setStatus}
          options={["All Status", "Approved", "Under Review", "Dissolved", "Special Class"]}
        />

        <button
          onClick={() => {
            if (selectedRows.length === 0) {
              alert("Please select at least one course to forward.");
              return;
            }
      ...
      {/* Table */}
      <div className="overflow-visible border border-gray-200 bg-gray-50 shadow-sm">
        ...
        <div className="fixed inset-0 z-[90] grid place-items-center bg-black/40 p-4">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <p className="mx-auto mb-6 max-w-md text-center text-sm text-neutral-600">
              ...
              <br />
              Once confirmed, these will be sent for approval.
            </p>
            <div className="flex justify-end gap-2">
              ...
              <button
                onClick={() => {
                  ...
                  alert(`✅ ${selectedRows.length} course(s) forwarded successfully!`);
                  setSelectedRows([]);
                }}
